...
class MusicPlayer:
    def __init__(self, media_directory):
        ...
        # Load the icons with modified colors
    ...
    def run(self):
        ...
        while running:
            ...
            text = self.font.render(self.media_files[self.current_media_index], True, (255, 255, 255))
            text_rect = text.get_rect(center=(self.window_width // 2, self.window_height // 2))
            self.window.blit(text, text_rect)

            # Display the volume level
            volume_text = self.font.render(f"Volume: {int(pygame.mixer.music.get_volume() * 100)}%", True, (255, 255, 255))
